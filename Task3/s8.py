...
# 国庆节
national_day_start_dates = ["2022-09-30", "2023-9-30"]
...
# 生成清明节的所有日期，持续时间为 10 天
national_day = generate_holiday_dates(national_day_start_dates, 10)
...
# 判断训练数据的索引是否在国庆节日期列表中，生成布尔型列 "is_labor"
train_data["is_national_day"] = train_data.index.isin(national_day)
...
sample_submit.to_csv("submit8.csv", index=False)